...
class UDList {
    ...
    /*
     Function to update events provided the index in event list, upadted reservation status and updated number of tickets
     */
    ...
    /*
     Function to read from user default events list
     */
